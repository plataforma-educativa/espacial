...
public class DibujoEspacialDeNave extends Group implements DibujoEspacialPartidario {
    ...
    public static final Paint PINTURA_FACCION_RIVAL = Color.web("AA0022FF");
    ...
    public void siEsAliado() {
        ...
        pintura = PINTURA_FACCION_ALIADO;
    }

    @Override
    public void siEsNeutral() {

        pintura = PINTURA_FACCION_NEUTRAL;
    }

    @Override
    public void siEsRival() {

        pintura = PINTURA_FACCION_RIVAL;
    }
}
